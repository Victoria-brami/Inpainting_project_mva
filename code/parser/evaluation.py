...
def parser():
    ...
    parser.add_argument('--checkpointpath', type=str, default='../results/no_global/phase_3_only/no_global_model_cn_step400000')
    parser.add_argument('--device', type=str, default='cpu')
    parser.add_argument('--niter', default=20, type=int, help="number of iterations")
    parser.add_argument('--data_dir', default='../../celebA/partial_img_align_celeba')
