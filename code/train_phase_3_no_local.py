...
from models import CompletionNetwork, TunedContextDiscriminator
...
def main(args):
    ...
    model_cd = TunedContextDiscriminator(
        local_input_shape=None,
    ...
    while pbar.n < args.steps_3:
        for x in train_loader:
            ...
            output_fake = model_cd(input_gd_fake)
